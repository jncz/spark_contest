...
(function() {
    ...
    function V(a, b, c) {
        ...
        else if (r(b) && ia(b)) for (d in b) a.setAttribute(d, b[d]);
        return e
    }
    function pa(a) {
        return Ka(a) ? a : [a]
    ...
    function Nb() {
        ...
        mb = function(a, c, d, h, i, j) {
            var k;
            b ? (k = fa.UTC.apply(0, arguments), k += bb(k)) : k = (new fa(a, c, p(d, 1), p(h, 0), p(i, 0), p(j, 0))).getTime();
            return k
        };
        yb = c + "Minutes";
        zb = c + "Hours";
    ...
    var s, D = document,
        ...
        ea = !! D.createElementNS && !! D.createElementNS(Ia, "svg").createSVGRect,
        ...
        $b = "stroke-width",
        fa, mb, ub, kb, yb, zb, Ab, cb, db, eb, Ob, Pb, Qb, Rb, Bb, Cb, Db, K = {}, A;
    ...
    A.numberFormat = function(a, b, c, d) {
        var e = P.lang,
            a = +a || 0,
            f = b === -1 ? B((a.toString().split(".")[1] || "").length, 20) : isNaN(b = Q(b)) ? 2 : b,
            ...
            init: function(b) {
                ...
                a.fn.highcharts = function() {
                    ...
                    if (this[0]) {
                        ...
                        c = b[0];
                        if (c !== s) c.chart = c.chart || {}, c.chart.renderTo = this[0], new A[a](c, b[1]), g = this;
    ...
    Y.prototype = {
        ...
        applyTextShadow: function(a) {
            var b = this.element,
                ...
                e = this.renderer.forExport || b.style.textShadow !== s && !Ea;
    ...
    na.prototype = {
        ...
        init: function(a, b, c, d, e) {
            ...
            this.boxWrapper = d;
            this.alignedObjects = [];
            this.url = (Va || Gb) && D.getElementsByTagName("base").length ? f.href.replace(/#.*?$/, "").replace(/([\('\)])/g, "\\$1").replace(/ /g, "%20") : "";
                ...
                n(g, function(e) {
                    if (e !== "" || g.length === 1) {
                        ...
                        if (e !== " ") {
                            ...
                            if (m) {
                                for (var o = e.replace(/([^\^])-/g, "$1- ").split(" "), n = g.length > 1 || f || o.length > 1 && k.whiteSpace !== "nowrap", p, M, s, r = [], w = z(t), v = 1, x = a.rotation, y = e, B = y.length;
        ...
        button: function(a, b, c, d, e, f, g, h, i) {
            ...
            E(j.element, Ea ? "mouseout" : "mouseleave", function() {
                k !== 3 && (m = [e, f, g][k], l = [o, q, t][k], j.attr(m).css(l))
            });
    ...
    if (!ea && !ma) G = {
        ...
        pathToVML: function(a) {
            for (var b = a.length, c = []; b--;) if (sa(a[b])) c[b] = w(a[b] * 10) - 5;
            else if (a[b] === "Z") c[b] = "x";
        ...
        color: function(a, b, c, d) {
            ...
            if (i) {
                ...
                if (c === "fill") if (i === "gradient") c = l.x1 || l[0] || 0, a = l.y1 || l[1] || 0, o = l.x2 || l[2] || 0, l = l.y2 || l[3] || 0, u = 'angle="' + (90 - X.atan((l - a) / (o - c)) * 180 / va) + '"', s();
                else {
                    var j = l.r,
                        r = j * 2,
                        w = j * 2,
    ...
    Za.prototype = {
        ...
        render: function(a, b, c) {
            ...
            if (i && !isNaN(x)) i.xy = v = this.getLabelPosition(x, v, i, g, k, w, a, oa), this.isFirst && !this.isLast && !p(e.showFirstLabel, 1) || this.isLast && !this.isFirst && !p(e.showLastLabel, 1) ? r = !1 : g && !d.isRadial && !k.step && !k.rotation && !b && c !== 0 && this.handleOverflow(v), oa && a % oa && (r = !1), r && !isNaN(v.y) ? (v.opacity = c, i[this.isNew ? "attr" : "animate"](v), this.isNew = !1) : i.attr("y", - 9999)
        },
        destroy: function() {
            Na(this, this.axis)
        }
    ...
    I.prototype = {
        ...
        defaultLabelFormatter: function() {
            ...
            else if (f && a >= 1E3) for (; f-- && g === s;) c = Math.pow(1E3, f + 1), a >= c && e[f] !== null && (g = A.numberFormat(b / c, - 1) + e[f]);
        ...
        setTickInterval: function(a) {
            ...
            b.tickInterval = b.min === b.max || b.min === void 0 || b.max === void 0 ? 1 : h && !k && m === b.linkedParent.options.tickPixelInterval ? b.linkedParent.tickInterval : p(k, this.tickAmount ? (b.max - b.min) / v(this.tickAmount - 1, 1) : void 0, l ? 1 : (b.max - b.min) * m / v(b.len, m));
        ...
        renderUnsquish: function() {
            var a = this.chart,
                ...
                j = {}, g = b.fontMetrics(e.style.fontSize, d[0] && d[0].label),
                k, m = 0;
    ...
    d) {
        ...
        if (r(b)) {
            ...
            b = 1;
            if (ub || kb) i = i.getTime(), i = new fa(i + bb(i));
            h = i[eb]();
    ...
    I.prototype.getLogTickPositions = function(a, b, c, d) {
        ...
        else if (a >= 0.08) for (var f = W(b), h, i, j, k, m, e = a > 0.3 ? [1, 2, 4] : a > 0.15 ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9]; f < c + 1 && !m; f++) {
            i = e.length;
    ...
    rb.prototype = {
        init: function(a, b) {
            var c = this,
                ...
                e = b.itemMarginTop || 0;
            this.options = b;
            if (b.enabled) c.itemStyle = d, c.itemHiddenStyle = y(d, b.itemHiddenStyle), c.itemMarginTop = e, c.padding = d = p(b.padding, 8), c.initialItemX = d, c.initialItemY = d - 5, c.maxItemWidth = 0, c.chart = a, c.itemHeight = 0, c.symbolWidth = p(b.symbolWidth, 16), c.pages = [], c.render(), E(c.chart, "endResize", function() {
    ...
    O.prototype = {
            ...
            if (d !== !1 && h && g === h && !e.cropped && !e.hasGroupedData && e.visible) n(a, function(a, b) {
                ...
                if (o && h > o) {
                    ...
                    if (sa(k)) {
                        ...
                        e.xIncrement = l
                    } else if (Ka(k)) if ($) for (c = 0; c < h; c++) i = a[c], q[c] = i[0], t[c] = i.slice(1, $ + 1);
                    else for (c = 0; c < h; c++) i = a[c], q[c] = i[0], t[c] = i[1];
                    else qa(12)
        ...
        processData: function(a) {
            ...
            if (k && this.sorted && (!i || d > i || this.forceCrop)) if (b[d - 1] < m || b[0] > l) b = [], c = [];
        ...
        generatePoints: function() {
            ...
            for (l = 0; l < g; l++) i = h + l, j ? m[l] = (new f).init(this, [d[l]].concat(pa(e[l]))) : (b[i] ? k = b[i] : a[i] !== s && (b[i] = k = (new f).init(this, a[i], d[l])), m[l] = k), m[l].index = i;
        ...
        getExtremes: function(a) {
            ...
            d = a.length;
            for (m = 0; m < d; m++) if (j = c[m], k = a[m], i = k !== null && k !== s && (!b.isLog || k.length || k > 0), j = this.getExtremesFromAll || this.cropped || (c[m + 1] || j) >= g && (c[m - 1] || j) <= h, i && j) if (i = k.length) for (; i--;) k[i] !== null && (e[f++] = k[i]);
            else e[f++] = k;
            this.dataMin = Sa(e);
            this.dataMax = Fa(e)
        },
        ...
        drawPoints: function() {
            ...
            if (m.enabled !== !1 || this._hasPointMarkers) for (f = b.length; f--;) if (g = b[f], d = W(g.plotX), e = g.plotY, k = g.graphic, o = g.marker || {}, q = !! g.marker, a = z && o.enabled === s || o.enabled, t = g.isInside, a && e !== s && !isNaN(e) && g.y !== null) if (a = g.pointAttr[g.selected ? "select" : ""] || l, h = a.r, i = p(o.symbol, this.symbol), j = i.indexOf("url") === 0, k) k[t ? "show" : "hide"](!0).animate(x({
                x: d - h,
                y: e - h
            }, k.symbolName ? {
                width: 2 * h,
        ...
        searchKDTree: function(a) {
            function b(a, h, i, j) {
                ...
                l = {
                    ...
                    distY: r(q) ? Math.sqrt(q) : Number.MAX_VALUE,
    ...
    Da = ja(O, {
        ...
        drawPoints: function() {
            ...
            n(a.points, function(h) {
                ...
                } : {}, g = h.pointAttr[h.selected ? "select" : ""] || a.pointAttr[""], j ? (ab(j), j.attr(i)[b.pointCount < e ? "animate" : "attr"](y(f))) : h.graphic = d[h.shapeType](f).attr(i).attr(g).add(a.group).shadow(c.shadow, null, c.stacking && !c.borderRadius);
    ...
    N = {
        ...
        pointClass: ja(Ca, {
            ...
            setVisible: function(a, b) {
                ...
                if (a !== c.visible || b) if (c.visible = c.options.visible = a = a === s ? !c.visible : a, d.options.data[Oa(c, d.data)] = c.options, n(["graphic", "dataLabel", "connector", "shadowGroup"], function(b) {
                ...
                if (I) {
                    ...
                    if (l > 0) {
                        ...
                        for (J = 0; J < I; J++) {
                            ...
                            if (F < J && G[J] !== null) F = J;
                            else for (u < I - J + F && G[J] !== null && (F = u - I + J); G[F] === null;) F++;
                            L.push({
                                i: F,
                                y: G[F]
                            });
                    ...
                    for (J = 0; J < I; J++) {
                        ...
                        z.connX = y;
                        z.connY = A;
                        if (this.options.size === null) u = z.width, y - u < f ? C[3] = v(w(u - y + f), C[3]) : y + u > h - f && (C[1] = v(w(y + u - h + f), C[1])), A - b / 2 < 0 ? C[0] = v(w(-A + b / 2), C[0]) : A + b / 2 > i && (C[2] = v(w(A + b / 2 - i), C[2]))
                    }
                }
            }
    ...
    x(I.prototype, {
        beforeSetTickPositions: function() {
            ...
            if (a.options.ordinal || a.options.breaks) {
                ...
                d ? (a.ordinalPositions = c, e = a.val2lin(v(g, c[0]), !0), h = v(a.val2lin(B(f, c[c.length - 1]), !0), 1), a.ordinalSlope = f = (f - g) / (h - e), a.ordinalOffset = g - e * f) : a.ordinalPositions = a.ordinalSlope = a.ordinalOffset = s;
    ...
    da.groupData = function(a, b, c, d) {
        ...
        for (; n <= i; n++) {
            ...
            if (o) {
                ...
                var p;
                for (k = 0; k < q; k++) if (p = j[o[k]], typeof p === "number") l[k].push(p);
    ...
    N.tooltipFooterHeaderFormatter = function(a, b) {
        var c = a.series,
            ...
            f = d.xDateFormat,
            g, h = c.xAxis;
        h && h.options.type === "datetime" && e && sa(a.key) ? (c = c.currentDataGrouping, e = e.dateTimeLabelFormats, c ? (h = e[c.unitName], c.count === 1 ? f = h[0] : (f = h[1], g = h[2])) : !f && e && (f = this.getXDateFormat(a, d, h)), f = ka(f, a.key), g && (f += ka(g, a.key + c.totalRange - 1)), d = d[(b ? "footer" : "header") + "Format"].replace("{point.key}", f)) : d = lc.call(this, a, b);
        return d
    };
    da.destroy = function() {
    ...
    N = ja(K.column, {
        ...
        drawPoints: function() {
            ...
            n(a.points, function(k) {
                if (k.plotY !== s) i = k.graphic, c = k.pointAttr[k.selected ? "selected" : ""] || a.pointAttr[""], f = c["stroke-width"] % 2 / 2, j = w(k.plotX) - f, g = w(k.shapeArgs.width / 2), h = ["M", j, w(k.yBottom), "L", j, w(k.plotY)], k.open !== null && (d = w(k.plotOpen) + f, h.push("M", j, d, "L", j - g, d)), k.close !== null && (e = w(k.plotClose) + f, h.push("M", j, e, "L", j + g, e)), i ? i.attr(c).animate({
                    d: h
    ...
    K.flags = ja(K.column, {
        ...
        translate: function() {
            ...
            n(b, function(c, d) {
                var f;
                if (c.plotY === s) c.x >= j.min && c.x <= j.max ? c.plotY = a.chartHeight - i.bottom - (i.opposite ? i.height : 0) + i.offset - a.plotTop : c.shapeArgs = {};
        ...
        drawPoints: function() {
            var a, b = this.pointAttr[""],
                ...
                o, n;
            for (j = c.length; j--;) if (k = c[j], a = k.plotX > this.xAxis.len, e = k.plotX + (a ? l : -l), m = k.stackIndex, i = k.options.shape || g.shape, f = k.plotY, f !== s && (f = k.plotY + h + l - (m !== s && m * g.stackDistance)), o = m ? s : k.plotX + l, n = m ? s : k.plotY, m = k.graphic, f !== s && e >= 0 && !a) a = k.pointAttr[k.selected ? "select" : ""] || b, m ? m.attr({
                x: e,
                y: f,
                r: a.r,
                anchorX: o,
    ...
    Eb.prototype = {
        ...
        init: function() {
            ...
            a.mouseDownHandler = function(d) {
                var d = b.pointer.normalize(d),
                    ...
                    d = b.xAxis[0],
                    w, x = fb ? 10 : 7;
                if (v > h && v < h + g + j) if ((h = !a.scrollbarEnabled || v < h + g) && X.abs(s - e - l) < x) a.grabbedLeft = !0, a.otherHandlePos = f, a.fixedExtreme = d.max, b.fixedRange = null;
        ...
        addBaseSeries: function() {
            ...
            if (a && this.navigatorOptions.adaptToUpdatedData !== !1) E(a, "updatedData", this.updatedDataHandler), a.userOptions.events = x(a.userOptions.event, {
    ...
    Fb.prototype = {
        ...
        render: function(a, b) {
            var c = this,
                ...
                g = c.inputGroup,
                m = i.buttonTheme,
                l = i.buttonPosition || {}, o = i.inputEnabled,
                q = m && m.states,
                t = d.plotLeft,
                s, v, u = c.group;
    ...
    R(I.prototype, "getPlotLinePath", function(a, b, c, d, e, f) {
        ...
        n(g.isXAxis ? i.yAxis : i.xAxis, function(a) {
            if (r(a.options.id) ? a.options.id.indexOf("navigator") === -1 : 1) {
        ...
        isNaN(f) || (g.horiz ? n(u, function(a) {
            ...
            q = l + a.len;
            o = s = w(m + g.height - f);
            if (o < m || o > m + g.height) e ? o = s = B(v(m, o), g.top + g.height) : b = !0;
            b || x.push("M", l, o, "L", q, s)
        }));
    ...
    I.prototype.getPlotBandPath = function(a, b) {
        var c = this.getPlotLinePath(b, null, null, !0),
            ...
            e = [],
            f;
        if (d && c && d.toString() !== c.toString()) for (f = 0; f < d.length; f += 6) e.push("M", d[f + 1], d[f + 2], "L", d[f + 4], d[f + 5], c[f + 4], c[f + 5], c[f + 1], c[f + 2]);
        else e = null;
        return e
    };
    na.prototype.crispPolyLine = function(a, b) {
        var c;
        for (c = 0; c < a.length; c += 6) a[c + 1] === a[c + 4] && (a[c + 1] = a[c + 4] = w(a[c + 1]) - b % 2 / 2), a[c + 2] === a[c + 5] && (a[c + 2] = a[c + 5] = w(a[c + 2]) + b % 2 / 2);
        return a
    };
